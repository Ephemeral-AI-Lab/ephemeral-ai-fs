...
fn physical_json(receipt: layerfs_layerstack_store::PhysicalStorageReceipt) -> String {
    let fields = [
        ...
        ("native_record_fetches", receipt.native_record_fetches),
        ("native_request_bytes", receipt.native_request_bytes),
        ("native_parser_bytes", receipt.native_parser_bytes),
        ("native_raw_decoded_bytes", receipt.native_raw_decoded_bytes),
        ("native_decode_calls", receipt.native_decode_calls),
        ("native_decode_ns", receipt.native_decode_ns),
        ("native_dependency_edges", receipt.native_dependency_edges),
        ("native_depth_0", receipt.native_depth_0),
        ("native_depth_1", receipt.native_depth_1),
        ("native_depth_2", receipt.native_depth_2),
        ("native_depth_3", receipt.native_depth_3),
        ("native_depth_4", receipt.native_depth_4),
        ("native_full_encode_calls", receipt.native_full_encode_calls),
