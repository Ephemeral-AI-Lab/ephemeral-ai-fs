...
Use the tagged repository source; published downloads are listed in the
[release artifact record](../../../release-notes/0.1.3/artifacts.md).

## Build

Clone the release, then build from its repository root:

```bash
git clone --branch v0.1.3 --depth 1 https://github.com/Ephemeral-AI-Lab/layerfs.git
cd layerfs
