...
From the v0.1.3 source checkout with Docker running and Python 3 available:
...
[release artifact record](../../../release-notes/0.1.3/artifacts.md); a local
...
owned and charged. Fsync/Commit fences perform the required backing checks.
Ambiguous backing errors fail the owner rather than replaying an append.
...
[release notes](../../../release-notes/0.1.3/README.md); setup, product operations
