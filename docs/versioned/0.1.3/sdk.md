...
runtime architecture and concurrency behavior changed in 0.1.3; old descriptions
...
and the [release notes](../../../release-notes/0.1.3/README.md) for their separate
