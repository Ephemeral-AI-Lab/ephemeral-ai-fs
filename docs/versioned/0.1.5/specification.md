...
Resource policies bound Workspace spool, pending representation and
final-delta use. Canonical construction, object admission, queries and reads use
their own bounded buffers; one buffer limit is not a whole-process memory limit.
