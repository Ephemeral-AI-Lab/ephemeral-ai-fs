...
runtime architecture and concurrency behavior introduced in 0.1.3 remain in
0.1.5; old descriptions of a host-only mutable Workspace or a fresh helper
process per mount do not apply to this release. Do not mix active runtime
components from different versions. See [container runtime](container-runtime.md),
[storage](storage-format.md) and the [qualification report](../../../release-notes/0.1.5/verification.md)
