# LayerFS 0.1.5 container runtime
...
From the v0.1.5 checkout with Docker running and Python 3 available:
...
the [release record](../../../release-notes/0.1.5/README.md); setup, product operations
