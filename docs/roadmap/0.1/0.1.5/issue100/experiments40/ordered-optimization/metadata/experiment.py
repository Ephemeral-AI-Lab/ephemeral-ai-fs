...
EXPECTED='ff2eb0bbff39cb822f5fe33514dd84adce817f2d86f4041296220211ba91a8f4'
MAGIC=b'LFSIVL1\0'
def sha(p):
...
def main():
 ...
 inv,roots,content,scope,high=e.D.original_inventory();assert len(inv)==10542 and len(roots)==54
