...
spec=importlib.util.spec_from_file_location('content_metadata_reader',HERE.parent.parent/'metadata/v2-157/reader.py');meta=importlib.util.module_from_spec(spec);spec.loader.exec_module(meta)
