"""Cached full54-D metadata and actualpack API; never replays or re-encodes history."""
...
if __name__=='__main__':
    ...
    assert len(roots)==54 and sum(len(b) for p,b in packs)==result['pack_bytes']
    assert len(inode_oracle())==high and len(root_map())==54
    print('PASS cachedfull54metadataAPI: exactinventory,allpackSHA256hashes,54roots,oracle/highwater')
