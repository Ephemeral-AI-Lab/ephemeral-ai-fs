...
ROOT=Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-issue100-45mb-evidence');BASE=Path('/Users/yifanxu/Ephemeral-AI-Lab/deepseek-history-data');RUN=Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-issue100-stride3-comparison/layerfs');STORE=RUN/'deepseek-stride3/host-runtime/store.sqlite'
def sha(p):return hashlib.sha256(p.read_bytes()).hexdigest()
BEFORE=sha(STORE);assert BEFORE=='5c6ee04eee133539f043ee64d242c26769c77d30b434af2523666e326a8d999e'
