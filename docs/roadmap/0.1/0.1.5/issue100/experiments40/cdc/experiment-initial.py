...
for s in samples:
 ...
 for index,id in enumerate(s['hints']):
  ...
  elif budget['lookups']+info['lookups']>8 or budget['encoded_work']+info['encoded_work']>524288 or budget['decoded_work']+info['decoded_work']>524288:reason='cumulative_target_read_budget'
  if reason:
