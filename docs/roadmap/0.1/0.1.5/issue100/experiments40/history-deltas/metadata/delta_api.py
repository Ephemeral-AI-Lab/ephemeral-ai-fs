"""Cached matched FULL/depth1 pack export, unchanged Dcanonical inventory/roots."""
...
if __name__=='__main__':
    ...
    print('PASS cached FULL/DELTAexports: all776packhashes/locators,all24748exactcanonicalreconstructions,158unchangedroots')
