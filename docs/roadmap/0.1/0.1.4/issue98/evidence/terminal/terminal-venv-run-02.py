...
here = Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-workspace-admission/docs/roadmap/0.1/0.1.4/issue71-venv-acceptance')
repo = here.parents[4]
plan = json.loads((here / "plan.json").read_text())
plan["product_commit"] = "9cfb4be477116646258ea0621280ed13b1824c6d"
plan["image"] = 'sha256:42eb806fcfe9db1dc28098eb423340de3e4eaf81fd487389128305e65606d347'
out = Path(sys.argv[1]).resolve()
assert not out.exists(), "fresh output directory required"
source = Path(plan["source"])
archive = Path(plan["archive"]["archive"])
binary = Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-workspace-admission-runs/final-venv-proof')
