...
for label in ['deepseek','edits','small']:
 a=r/f'issue88-C-control-{label}-1';b=r/f'issue88-C-candidate-{label}-1';assert json.loads((a/'identity.json').read_text())['fixtures']==json.loads((b/'identity.json').read_text())['fixtures']
