...
ROOT=pathlib.Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-issue91-runs/source-g3')
OUT=ROOT.parent/'g3-headline-01'
...
image_tag=(ROOT.parent/'build-g3/image.log').read_text().strip().splitlines()[-1]
...
(OUT/'declaration.json').write_text(json.dumps(dict(source=str(ROOT),host=identity,image=image,cases=cases,
 seed=1,diagnostic_only=True,amendment='5ac4d630d',initialization_diagnostic_nonce='91',
