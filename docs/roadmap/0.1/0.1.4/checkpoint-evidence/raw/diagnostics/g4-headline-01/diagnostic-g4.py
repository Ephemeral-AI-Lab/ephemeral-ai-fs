...
ROOT=pathlib.Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-issue91-runs/source-g4')
OUT=ROOT.parent/'g4-headline-01'
...
image_tag=(ROOT.parent/'build-g4/image.log').read_text().strip().splitlines()[-1]
...
(OUT/'declaration.json').write_text(json.dumps(dict(source=str(ROOT),host=identity,image=image,cases=cases,
 seed=1,diagnostic_only=True,amendment='577fbae05',initialization_diagnostic_nonce='91',
