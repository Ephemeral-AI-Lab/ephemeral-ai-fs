...
ROOT=pathlib.Path('/Users/yifanxu/Ephemeral-AI-Lab/layerfs-issue91-runs/source-g9')
OUT=ROOT.parent/'g9-headline-01'
...
image_tag=(ROOT.parent/'build-g9/image.log').read_text().strip().splitlines()[-1]
...
(OUT/'declaration.json').write_text(json.dumps(dict(source=str(ROOT),host=identity,image=image,cases=cases,
 seed=1,diagnostic_only=True,amendment='da3df9177',initialization_diagnostic_nonce='91',
