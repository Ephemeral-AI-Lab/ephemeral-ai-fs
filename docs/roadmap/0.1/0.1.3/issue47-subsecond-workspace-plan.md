...
## Mixed-v3 migration amendment

The approved [mixed bulk v3 contract](tiny-file-churn-mixed-v3.md) supersedes original high-tier bulk IDs/counts in this historical plan. Active tier100 create/delete affect1,000files/100MiB and tier500 affect5,000files/500MiB, each with the unchanged200-file/1MiB witness. Preserve original receipts; only newly measured `-mixed-v3` cases can qualify the revised contract. Migration and one serial tier100 pair precede #49; tier500 performance and final independent proofs remain deferred.
