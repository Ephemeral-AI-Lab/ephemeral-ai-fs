...
pub use apply::{
    ...
    apply_inode_mutations, build_initial_directory, build_initial_directory_sorted,
    build_initial_namespace, create_directory, create_symlink, hard_link, remove_path, rename,
    replace_file, replace_range, replace_range_with_metadata, symlink_content, CandidateRoot,
    InodeMutation, StructuralBatchCounters,
};
pub use change::{
