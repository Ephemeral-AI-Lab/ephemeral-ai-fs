...
pub use objects::{
    ...
    CompactionOptions, CompactionReceipt, CoreReader, DeferredObjectStore, FinalizedOutputWriter,
    ObjectBuffer, ObjectSource, SpillableObjectSet, WorkspaceAdmission, ADMISSION_BATCH_COUNT,
