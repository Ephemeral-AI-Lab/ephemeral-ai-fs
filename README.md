...
| **0.1.3** | Workspace, CAS/CDC, single-Branch history and reliability checkpoint; 198 performance and 226 routine verification passes. | **Closed**; see the [checkpoint and limitations](docs/roadmap/0.1/0.1.3/README.md). |
